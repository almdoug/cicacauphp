                    ...
                    @if($cost->updated_at_data)
                        <div class="flex items-center gap-3">
                            ...
                            <div>
                                ...
                                <p class="text-sm font-medium text-gray-900">{{ $cost->getFormattedUpdatedAtData() }}</p>
                            </div>
                        </div>
                    @endif
                    ...
                    @if($cost->unit)
                        <div class="flex items-center gap-3">
                            ...
                            <div>
                                ...
                                <p class="text-sm font-medium text-gray-900">{{ $cost->unit }}</p>
                            </div>
                        </div>
                    @endif
                </div>
