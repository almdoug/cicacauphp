...
@section('page-title', 'Novo Custo de Produção')

@section('content')
<div class="max-w-4xl">
    <div class="bg-white rounded-lg shadow">
        <div class="p-4 sm:p-6 border-b border-gray-200 bg-gradient-to-r from-primary/5 to-secondary/5">
            <h3 class="text-lg font-semibold text-gray-900">Cadastrar Novo Custo de Produção</h3>
            <p class="text-sm text-gray-600 mt-1">Preencha os campos abaixo para cadastrar um novo custo de produção</p>
        </div>

        <form action="{{ route('admin.production-costs.store') }}" method="POST" enctype="multipart/form-data" class="p-4 sm:p-6 space-y-6">
            @csrf
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <input 
                        ...
                        placeholder="Ex: Bahia, Sul da Bahia"
                    >
                    @error('region')
                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                    @enderror
                ...
                <div>
                    ...
                    <input 
                        ...
                        placeholder="Ex: 2024, Jan-Jun 2024"
                    >
                    @error('period')
                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                    @enderror
                ...
                <div>
                    ...
                    <input 
                        ...
                        placeholder="Ex: CEPLAC, IBGE, CONAB"
                    >
                    @error('source')
                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                    @enderror
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    >
                    <p class="mt-1 text-sm text-gray-500">Formatos: PDF, XLSX, XLS, CSV (máximo 10MB)</p>
                    @error('file')
                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                    @enderror
                </div>
