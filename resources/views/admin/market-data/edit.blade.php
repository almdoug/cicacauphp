...
<div class="max-w-4xl">
    <div class="bg-white rounded-lg shadow">
        ...
        <form action="{{ route('admin.market-data.update', $marketData) }}" method="POST" class="p-4 sm:p-6 space-y-6">
            @csrf
            @method('PUT')
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <input 
                        ...
                        name="frequency" 
                        id="frequency" 
                        value="{{ old('frequency', $marketData->frequency) }}"
                ...
                <div>
                    ...
                    <input 
                        ...
                        name="location" 
                        id="location" 
                        value="{{ old('location', $marketData->location ?? 'Brasil') }}"
                ...
                <div>
                    ...
                    <input 
                        ...
                        name="source_link" 
                        id="source_link" 
                        value="{{ old('source_link', $marketData->source_link) }}"
                ...
                <div>
                    ...
                    <input 
                        ...
                        id="updated_at_data" 
                        value="{{ old('updated_at_data', $marketData->updated_at_data ? $marketData->updated_at_data->format('Y-m-d') : '') }}"
            ...
            <div>
                ...
                >{{ old('comment', $marketData->comment) }}</textarea>
            ...
            @include('admin.partials.data-series-form', ['dataItems' => $marketData->dataSeries])
